...
export const SEASON_MAPPINGS: Record<number, SeasonPackMapping> = {
  ...
  22: {
    split1: {
      freeTrack: [4, 19, 27, 39, 51, 59],
      premiumTrack: [9, 14, 17, 22, 29, 34, 38, 42, 43, 45, 55, 58],
      maxLevel: 60,
    },
    split2: {
      freeTrack: [5, 15, 26, 39, 43, 51, 59],
      premiumTrack: [9, 17, 22, 27, 38, 45, 55],
      maxLevel: 60,
    },
  },
  23: {
    split1: {
      freeTrack: [4, 17, 26, 39, 42, 52, 59],
      premiumTrack: [15, 22, 27, 38, 44, 55],
      maxLevel: 60,
    },
    split2: {
      freeTrack: [5, 15, 26, 39, 43, 51, 59],
      premiumTrack: [9, 17, 22, 27, 38, 45, 55, 59],
      maxLevel: 60,
    },
  },
  24: {
    split1: {
      freeTrack: [5, 15, 26, 38, 47, 51, 58],
      premiumTrack: [9, 17, 22, 27, 37, 44, 55],
      maxLevel: 60,
    },
    split2: {
      freeTrack: [5, 15, 26, 38, 47, 51, 58],
  ...
  27: {
    split1: {
      freeTrack: [5, 15, 38, 47, 51, 58],
      premiumTrack: [9, 17, 22, 27, 32, 44, 55],
      maxLevel: 60,
    },
    split2: {
      freeTrack: [5, 15, 38, 47, 51, 58],
